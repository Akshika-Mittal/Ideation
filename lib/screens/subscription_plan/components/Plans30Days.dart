...
class Plan30Days extends StatefulWidget {
  static String routeName="/plan30Days";

  @override
  State<Plan30Days> createState() => _Plan30DaysState();
}

class _Plan30DaysState extends State<Plan30Days> {
  ...
  updateText(int n){
    if(n==0){
      setState(() {
        ...
        details=['6 meals in box','30 days delivery','Validity 40 days','Choose from pure veg/non veg','Polling enabled','Special meals on Saturday & Sunday'];
      });
    }
    else if(n==1){
      setState(() {
        details.clear();icons.clear();
        icons=[Icons.all_inbox_rounded,Icons.delivery_dining,Icons.calendar_view_month_rounded,Icons.fact_check,Icons.poll,Icons.backup_table_rounded];
        details=['6 meals in box','60 days delivery','Validity 40 days','Choose from pure veg/non veg','Polling enabled','Special meals on Saturday & Sunday'];
      });
    }
    else if(n==2){
      setState(() {
        ...
        details=['No of boxes depend on diet plan','30 days delivery','Validity 40 days','Choose from pure veg/non veg','Meal plan according to dietician','Special meals on Saturday & Sunday'];
      });
    }
    else if(n==3){
      setState(() {
        details.clear();icons.clear();
        icons=[Icons.all_inbox_rounded,Icons.delivery_dining,Icons.calendar_view_month_rounded,Icons.fact_check,Icons.add_moderator_rounded,Icons.backup_table_rounded];
        details=['No of boxes depend on diet plan','60 days delivery','Validity 40 days','Choose from pure veg/non veg','Meal plan according to dietician','Special meals on Saturday & Sunday'];
      });
    }
  }
...
class PlanDetails extends StatefulWidget {
  ...
  State<PlanDetails> createState() => _PlanDetailsState(
      this.screenHeight, this.screenWidth,this.planIndex,this.planName,this.fakePrice,this.actualPrice,this.des1,this.des2);
}
...
class _PlanDetailsState extends State<PlanDetails> {
  ...
  _PlanDetailsState(
      this.screenHeight, this.screenWidth,this.planIndex,this.planName,this.fakePrice,this.actualPrice,this.des1,this.des2);
  String planDetails = 'Get hearty and appetizing food at your doorstep with us.';
  String imagePath ='assets/images/pic1.png';
  updateText(int n){
    if(n==0){
      setState(() {
        imagePath='assets/images/Pic2.png';
        planDetails = '6 meals in box\n30 days delivery\nValidity 40 days\nChoose from pure veg/non veg\nPolling enabled\nSpecial meals on Saturday & Sunday';
      });
    }
    else if(n==1){
      setState(() {
      ...
      setState(() {
        imagePath='assets/images/Pic2.png';
        planDetails = 'No of boxes depend on diet plan\n30 days delivery\nValidity 40 days\nChoose from pure veg/non veg\nMeal plan according to dietician\nSpecial meals on Saturday & Sunday';
      });
    }
    else if(n==3){
      setState(() {
